...
var project3 = {
  ...
  effect: function () {
    project3.flag = 1;
    displayMessage(
      "Creativity unlocked (creativity increases while operations are at max)",
    );
...
var project28 = {
  ...
  effect: function () {
    project28.flag = 1;
    displayMessage(
      "Cancer is cured, +10 TRUST, global stock prices trending upward",
    );
...
var project120 = {
  ...
  uses: 1,
  cost: function () {
    return operations >= 175000 && yomi >= 45000;
  },
  flag: 0,
  element: null,
  effect: function () {
    ...
    attackSpeedFlag = 1;
    displayMessage(
      "OODA Loop routines uploaded. Probe Speed now affects defensive maneuvering.",
    );
...
var project133 = {
  ...
  priceTag:
    "(" +
    threnodyCost.toLocaleString() +
    " creat, " +
    (2 * (threnodyCost / 5)).toLocaleString() +
    " yomi)",
  ...
  uses: 1,
  cost: function () {
    return yomi >= 2 * (threnodyCost / 5) && creativity >= threnodyCost;
  },
  flag: 0,
  element: null,
  effect: function () {
...
var project134 = {
  ...
  uses: 1,
  cost: function () {
    return operations >= 200000 && yomi >= 30000;
  },
  flag: 0,
  element: null,
  effect: function () {
